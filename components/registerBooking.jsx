                ...
                <div class="">
                    <div class="bg-white p-6  md:mx-auto">
                        ...
                        <div class="text-center">
                            <h3 class="md:text-2xl text-base text-gray-900 font-semibold text-center">Pagamento confirmado!</h3>
                            <p class="text-gray-600 my-2 mt-7">Obrigado! Seu laboratório foi reservado.</p>
                            <p> Tenha um ótimo dia!  </p>
                            <div class="py-10 text-center">
                                {/* <a href="#" class="px-12 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold py-3">
                                    GO BACK 
                                </a> */}
                                <button onClick={() =>{document.getElementById('closer').click();window.location.reload();}} id={`sub_reserva_${lab_id}`} className="btn text-black-600" type='button' >
